...
export const PROFILE = { // deploy test
  name: "OMRI LALO",
  ...
  branding: {
    logoStatic: "/media/images/logo_black.png",     // e.g. "/assets/logo-static.png"
    logoAnimated: "/media/videos/logoanimblack-ezgif.com-gif-maker.gif"    // e.g. "/assets/logo-anim.gif" (Plays on hover)
  },
  landing: {
...
export const PROJECTS: Project[] = [
  {
    ...
    thumbnail: '/media/images/CTRL/2.png',
    videoPreview: '/media/videos/CTRL_hover.mp4',
    ...
    images: [
      '/media/images/CTRL/2.png',
      '/media/images/CTRL/3.png',
      '/media/images/CTRL/P1066282.00_29_00_11.Still001.png',
      '/media/images/CTRL/1.png',
      '/media/images/CTRL/7.png',
      '/media/images/CTRL/10.png',
    ]
  },
  {
    id: 'TIMELESS',
    ...
    thumbnail: '/media/images/timeless/image4.png',
    videoPreview: '/media/videos/timeless_hover.mp4',
    ...
    images: [
      '/media/images/timeless/image1.png',
      '/media/images/timeless/image2.png',
      '/media/images/timeless/image3.png',
      '/media/images/timeless/image4.png',
      '/media/images/timeless/image5.png',
      '/media/images/timeless/image6.png',
    ]
  },
  {
    id: 'Auto-show',
    ...
    thumbnail: '/media/images/auto show/4.png',
    videoPreview: '/media/videos/cars_hover.mp4',
    ...
    images: [
      '/media/images/auto show/1.png',
      '/media/images/auto show/2.png',
      '/media/images/auto show/3.png',
      '/media/images/auto show/4.png',
      '/media/images/auto show/5.png',
      '/media/images/auto show/6.png',
    ]
  },
  {
    id: 'Snow-park',
    ...
    thumbnail: '/media/images/snow/1.png',
    videoPreview: '/media/videos/snow_hover.mp4',
    ...
    images: [
      '/media/images/snow/1.png',
      '/media/images/snow/2.png',
      '/media/images/snow/3.png',
      '/media/images/snow/4.png',
    ]
  },
  {
    id: 'Ninja-training',
    ...
    thumbnail: '/media/images/ninja/image2.png',
    videoPreview: '/media/videos/ninja_final.mp4',
    ...
    images: [
      '/media/images/ninja/image1.png',
      '/media/images/ninja/image2.png',
    ]
  },
  {
    id: 'Criminal-melody',
    ...
    thumbnail: '/media/images/criminal/Screenshot 2025-08-29 184143.png',
    videoPreview: '/media/videos/gangster6.mp4',
    ...
    images: [
      '/media/images/criminal/Screenshot 2025-08-29 184143.png',
      '/media/images/criminal/3.png',
      '/media/images/criminal/2.png',
      '/media/images/criminal/1.png',
    ]
  },
  {
    id: 'Big fish',
    ...
    thumbnail: '/media/images/fish/fish.png',
    videoPreview: '/media/videos/sport_fish.mp4',
